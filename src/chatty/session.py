...
class ChatbotSession:
  ...
  def __init__(
    ...
    default_prompt = (
      ...
      "CRITICAL: For performing search-and-replace edits (similar to 'sed'), you MUST use 'patch_file' (supporting one or more Aider-style SEARCH/REPLACE blocks) instead of using 'sed' or custom scripts in run_command.\n"
